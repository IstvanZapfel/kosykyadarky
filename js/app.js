 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-screen__slider")) new swiper_core_Swiper(".main-screen__slider", {
...
***************************************************************************** */
        ...
        if (isMobile.any()) {
            ...
            let menuSublist = document.querySelectorAll(".menu__sub-list");
            if (menuArrows.length > 0) for (let index = 0; index < menuArrows.length; index++) {
                ...
                for (let index = 0; index < menuSublist.length; index++) {
                    const menuSublists = menuSublist[index];
                    const close = event => !menuSublists.contains(event.target) && hideMenu(event);
        ...
        const scrollTop = function() {
            ...
            const scrollWindow = function() {
                if (window.scrollY != 0) setTimeout((function() {
